  ...
  theme: {
    extend: {
      colors: {
        ...
        "sh-card": "var(--card)",
        "sh-card-foreground": "var(--card-foreground)",
        "sh-popover": "var(--popover)",
        "sh-popover-foreground": "var(--popover-foreground)",
        "sh-primary": "var(--primary)",
        "sh-primary-foreground": "var(--primary-foreground)",
        "sh-secondary": "var(--secondary)",
        "sh-secondary-foreground": "var(--secondary-foreground)",
        "sh-muted": "var(--muted)",
        "sh-muted-foreground": "var(--muted-foreground)",
        "sh-accent": "var(--accent-shadcn)",
        "sh-accent-foreground": "var(--accent-shadcn-foreground)",
        "sh-destructive": "var(--destructive)",
        "sh-destructive-foreground": "var(--destructive-foreground)",
        "sh-border": "var(--border-shadcn)",
        "sh-input": "var(--input)",
        "sh-ring": "var(--ring)",
      },
      fontFamily: {
