      ...
      >
        ...
        >
          ...
          <div className="px-8 pb-8 pt-7 text-center">
            ...
            <button
              onClick={onClose}
              className="mt-5 w-full rounded-[12px] border border-[#6eaeea] bg-[linear-gradient(135deg,#184371_0%,#13629a_100%)] py-3 text-[0.9rem] font-bold text-white transition-all duration-200 hover:-translate-y-px hover:shadow-[0_10px_18px_rgba(15,127,179,0.24)]"
            >
              Return to overview
            </button>
