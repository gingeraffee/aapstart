...
export const adminApi = {
  ...
  updateEmployee: (employee_id: string, data: { first_name?: string; last_name?: string; tracks?: string[]; is_admin?: boolean; is_manager?: boolean; manager_employee_id?: string | null }) =>
