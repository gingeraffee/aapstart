...
acknowledgements:
  - id: ack-1
    statement: I understand when and how I can access Paylocity for paycheck information.
  - id: ack-2
    statement: I understand that most benefits become available after 60 days of employment.
  - id: ack-3
    statement: I understand that vacation requests must be submitted by 5:00 PM the business day before.
  - id: ack-4
    statement: I understand how to submit PTO requests in BambooHR.
  - id: ack-5
...
quiz:
  questions:
    ...
    - id: q5
      text: Which benefit is available on day one of employment?
      options:
        - id: a
          text: PTO
        - id: b
