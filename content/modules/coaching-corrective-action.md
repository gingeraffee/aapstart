---
slug: coaching-corrective-action
...
- Demonstrates fair and consistent treatment under Title VII, ADA, ADEA, and state laws.
- Provides evidence for employment decisions and helps defend against EEOC claims.
- Supports ADA compliance when medical conditions may impact performance.
- Protects against retaliation claims by showing issues existed before protected activity.
- Helps defend wage & hour claims by documenting attendance and timekeeping issues.
...
label: Coaching & Corrective Action Guide
description: Download the original coaching and corrective action guide used for this page.
:::

:::download
url: /downloads/Performance_Improvement_Plan_Template.pdf
label: Performance Improvement Plan (PIP) Template
description: Fillable PIP template for documenting performance expectations, action plans, check-in schedules, and outcomes.
:::

:::download
url: /downloads/Employee_Warning_Notice.pdf
label: Employee Warning Notice
description: Standard warning notice form for documenting violations, previous warnings, and employee acknowledgment.
:::
